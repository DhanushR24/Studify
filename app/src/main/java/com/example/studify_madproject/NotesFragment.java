...
import com.example.studify_madproject.model.Adapter;
...
public class NotesFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        contents.add("First note Content :)");

        titles.add("Second Note :)");
        contents.add("Second note Content :)");

        titles.add("Third Note :)");
        contents.add("This needs a lot of content to display stuff properly :) I am not sure if this much is sufficient");

        titles.add("Fourth Note :)");
        contents.add("Fourth note Content :)");
