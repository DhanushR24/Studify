...
public class MyApplication extends Application {
    ...
    public static final String formatTimesStamp(long timestamp){
        ...
        ref.getMetadata()
                .addOnSuccessListener(new OnSuccessListener<StorageMetadata>() {
                    ...
                    public void onSuccess(StorageMetadata storageMetadata) {
                        ...
                        Log.d(TAG,"On Success:"+pdfTitle+""+bytes);
        ...
        ref.getBytes(4)
                .addOnSuccessListener(new OnSuccessListener<byte[]>() {
                    ...
                    public void onSuccess(byte[] bytes) {
                        Log.d(TAG,"onSuccess: "+pdfTitle+"Succesfullly got the file");
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        progressBar.setVisibility((View.INVISIBLE));
                        Log.d(TAG,"On Failure: failes getting file from url due to "+e.getMessage());
                    }
                });
    }
